...
vim.keymap.set("n", "<Leader>E", ":Neotree reveal focus<CR>", { desc = "Open file explorer" })
vim.keymap.set("n", "<Leader>O", ":Neotree toggle focus<CR>", { desc = "Focus file explorer on buffer path" })
vim.keymap.set("n", "<Leader>bH", require("mini.bufremove").unshow_in_window, { desc = "Hide buffer from window" })
vim.keymap.set("n", "<Leader>bb", ":Neotree toggle focus buffers<CR>", { desc = "Show buffers" })
