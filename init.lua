...
vim.keymap.set("n", "<Leader>O", ":Neotree reveal reveal_file=%<CR>", { desc = "Focus file explorer on buffer path" })
vim.keymap.set("n", "<Leader>bB", ":Neotree reveal reveal buffers<CR>", { desc = "Show buffers" })
