...
vim.keymap.set("n", "<Leader>bb", ":Neotree focus buffers<CR>", { desc = "Show buffers" })
...
vim.keymap.set("n", "<Leader>gs", ":Neotree focus git_status<CR>", { desc = "Git status" })
...
vim.keymap.set("n", "<Leader>o", ":Neotree reveal focus<CR>", { desc = "Focus file explorer on buffer path" })
