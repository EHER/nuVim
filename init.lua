...
require("mini.files").setup({ mappings = { go_in_plus = "<CR>", go_out_plus = "-", synchronize = "<escape>" } })
...
vim.keymap.set("n", "<Leader>E", ":Neotree toggle reveal focus<CR>", { desc = "Open file explorer" })
vim.keymap.set("n", "<Leader>O", ":Neotree toggle reveal focus reveal_file=%<CR>", { desc = "Focus file explorer on buffer path" })
vim.keymap.set("n", "<Leader>bB", ":Neotree toggle focus reveal buffers<CR>", { desc = "Show buffers" })
...
vim.keymap.set("n", "<Leader>gS", ":Neotree toggle focus git_status<CR>", { desc = "Git status" })
